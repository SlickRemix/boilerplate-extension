...
class cupdater_check_class {
    ...
    function plugin_key_empty_admin_notice() {
        ...
        <div class="error notice">
            <p><?php _e($this->plugin_name . ' needs a valid License Key! <a href="edit.php?post_type=ft_gallery&page=ft-gallery-license-page">Click here to add one</a> or you won\'t recieve updates. - <a href="https://www.slickremix.com/my-account/" target="_blank">You can get License Key Here.</a>', CURRENT_PLUGIN_TEXT_DOMAIN); ?></p>
        </div>
    ...
    public function show_update_notification($file, $plugin) {
        ...
        if (!empty($update_cache->response[$this->name]) && version_compare($this->version, $version_info->new_version, '<')) {
            ...
            if (empty($version_info->download_link)) {
                printf(
                    __('There is a new version of %1$s available. %2$sView version %3$s details%4$s.', CURRENT_PLUGIN_TEXT_DOMAIN),
                ...
                printf(
                    __('There is a new version of %1$s available. %2$sView version %3$s details%4$s or %5$supdate now%6$s.', CURRENT_PLUGIN_TEXT_DOMAIN),
                    esc_html($version_info->name),
                    '<a target="_blank" class="thickbox" href="' . esc_url($changelog_link) . '">',
                    esc_html($version_info->new_version),
                    '</a>',
    ...
    public function show_changelog() {
        ...
        if (!current_user_can('update_plugins')) {
            wp_die(__('You do not have permission to install plugin updates', CURRENT_PLUGIN_TEXT_DOMAIN), __('Error', CURRENT_PLUGIN_TEXT_DOMAIN), array('response' => 403));
        }
